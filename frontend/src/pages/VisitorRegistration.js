...
export default function VisitorRegistration() {
  ...
  return (
    <div className="min-h-screen bg-slate-50" data-testid="visitor-registration">
      {/* Header */}
      <header className="bg-white border-b border-slate-200">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <ShieldCheck className="w-8 h-8 text-slate-900" />
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Visitor Registration</h1>
          </div>
          <Button 
            onClick={() => navigate('/')} 
            variant="ghost"
      ...
      <div className="container mx-auto px-6 py-12 max-w-2xl">
        ...
        {step === 'form' && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-lg p-8">
            <h2 className="text-3xl font-bold text-slate-900 mb-6 tracking-tight">Register as Visitor</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className="mt-2 h-10"
                  data-testid="visitor-mobile"
                />
              </div>

              <div>
                <Label htmlFor="person">Person to Visit *</Label>
                <Input
                  id="person"
                  type="text"
                  placeholder="Name of person you want to visit"
                  value={formData.person_to_visit}
                  onChange={(e) => setFormData({...formData, person_to_visit: e.target.value})}
                  required
                  className="mt-2 h-10"
                  data-testid="visitor-person"
                />
              </div>
        ...
        {step === 'success' && registrationData && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-lg p-8 text-center" data-testid="registration-success">
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200 inline-block mb-6" data-testid="visitor-qr">
            ...
            <div className="mb-6">
              ...
              <p className="text-xl font-semibold text-slate-900 font-mono" data-testid="visitor-valid-till">
